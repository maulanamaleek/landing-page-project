...
const Navbar = () => {
  return (
    <div className="h-24 md:h-32 flex justify-between w-full items-center px-5 lg:px-32">
        <div className="flex gap-10 items-center">
            <Image src="/logo.png" alt="berry labs logo" width={182} height={51} className="lg:mx-12" />
